    ...
    <Fragment>
      ...
      <div className='login well well-lg'>
        <Header as='h2' color='blue' textAlign='center'>
          <Header.Content>Редактировать профиль</Header.Content>
        </Header>
      </div>
      <hr />
      <Grid container textAlign='justified' columns='equal' divided>
        ...
        <Grid.Column width={4}>
          <ListGroup>
            <ListGroup.Item variant='primary'>Список статей:</ListGroup.Item>
            {journals.length > 0 ? (
              ...
              <ListGroup>
                ...
                <ListGroup.Item>Вы еще ничего не написали</ListGroup.Item>
                <Button inverted color='blue' className='m-2'>
                  <Link to='/create-journal'>Создать публикацию</Link>
                </Button>
              </ListGroup>
            )}
          </ListGroup>
